...
* **Container Image Registry/Repository.** This is a central place to store and load Container Images.
  ...
  * Personally, I'm hoping that tche state of the art will evolve past centralized solutions with specialized APIs to solutions that are simpler by working regular HTTP and more transport agnostic so that protocols like BitTorrent can be used to distribute images.
